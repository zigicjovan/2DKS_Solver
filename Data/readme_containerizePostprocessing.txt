####### MATLAB instructions - should be updated to Python
...
for dir in osg*; do
    cp base/collectFigures.sh base/generateFigures base/run_generateFigures.sh base/collectFigures.sub "$dir/"
done
