...
switch solplot
    case {'norms','gif','diagnostics','initial','terminal','optdiag','plotOptIC'}
        savedata = 1;
        [maxL2inT,u_IC,u_TC,energy,v_mean,projcoeffradialevolution,projcoeffmodeevolution] = ...
...
switch solplot
    ...
    case 'diagnostics'
        ...
        process_figure('diagnostics',originalIC, IC, dt, T, N, K, L_s1, L_s2, energy_og(:,2),utility2,Ntime,Ntime_save_max,tol,... 
                energy,v_mean,projcoeffradialevolution,projcoeffmodeevolution,...
                parameterlist,optparameters,parfiglist,optparfiglist)
    ...
    case 'optdiag'
        ...
        process_figure('state',originalIC, IC, dt, T, N, K, L_s1, L_s2, u_IC_og,u_TC_og,Ntime,Ntime_save_max,tol,... 
                energy_og,v_mean_og,projcoeffradialevolution_og,projcoeffmodeevolution_og,...
                parameterlist,optparameters,parfiglist,optparfiglist)
