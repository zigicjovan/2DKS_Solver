function [file1, file2, file3] = load_2DKSsolution(foldername, IC, dt, T, N, K, L_s1, L_s2, utility1, utility2)
    ...
    fullT = utility1(2);
    parameterlistT = [IC '_N_' num2str(N) '_dt_' num2str(dt) '_K_' num2str(K) '_Ls1_' num2str(L_s1,'%.2f') '_Ls2_' num2str(L_s2,'%.2f') '_t_' num2str(T) '_T_' num2str(fullT) ];
    parameterlist = [IC '_N_' num2str(N) '_dt_' num2str(dt) '_K_' num2str(K) '_Ls1_' num2str(L_s1,'%.2f') '_Ls2_' num2str(L_s2,'%.2f') '_T_' num2str(T) ];
    parameterlistcont = [IC '_N_' num2str(N) '_dt_' num2str(dt) '_K_' num2str(K) '_Ls1_' num2str(L_s1,'%.2f') '_Ls2_' num2str(L_s2,'%.2f') '_T_' ];
    saved = utility1(1);
    originalIC = utility2;
    switch foldername
