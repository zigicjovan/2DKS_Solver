function [result,iter_search,J_search] = optimize_stepsize(dir_cur,u_IC,step_size,IC,N,K,L_s1,L_s2,dt,T,Ntime_save_max,originalIC)
...
% find optimal stepsize for objective functional using Brent's method %
    ...
    [ ~ , u_TC ] = solve_2DKS(IC,'forward',N,K,L_s1,L_s2,dt,T,save_each,Ntime_save_max,update_term,originalIC);           % terminal forward state via forward equation
